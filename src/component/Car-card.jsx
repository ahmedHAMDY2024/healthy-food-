...
import Conferm from "./Conferm-pay";

function CarCard({props,children}){
    const [confermValid,setconfermValid]=useState(false)



    const handelCar=()=>{
        setconfermValid(!confermValid)
...
// console.log(children);
    ...
    return(
     <>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" fill="none" viewBox="0 0 128 128" style={{marginLeft:'auto',marginRight:'auto'}}>
        ...
        <path fill="#87635A" d="m119.983 24.22-47.147 5.76 4.32 35.36 44.773-5.467a2.377 2.377 0 0 0 2.017-1.734c.083-.304.104-.62.063-.933l-4.026-32.986Z"/><path fill="#AD8A85" d="m74.561 44.142 47.147-5.754 1.435 11.778-47.142 5.758-1.44-11.782Z"/>
        ...
        <path fill="#87635A" d="m59.156 57.66 1.68-14.88-16.827 13.173 15.147 1.707Z"/><path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth=".974" d="M9.796 52.06c-.667 5.866 16.24 12.586 37.733 15.04 14.774 1.68 27.867.906 34.854-1.654"/></svg>
        <div className="card-body">
            <p className="card-text">Your added items will appear here</p>
        </div>
        </div>
        <Conferm props={{confermValid,props,children}}/>
        <div className={props.dataCar>0?"carConfirm":"none"}>
            ...
            <span>Thes is a <b>carbon-nautral</b>delivery</span>
        </div>
        <div>
